...
namespace SuperScrollView
{
    ...
    public class LoopListViewEditor2 : Editor
    {
        ...
        SerializedProperty mItemInterruptAnim;
        ...
        GUIContent mItemInterruptAnimation = new GUIContent("ItemInterruptAnim");
        ...
        protected virtual void OnEnable()
        {
            ...
            mItemInterruptAnim = serializedObject.FindProperty("mItemInterruptAnim");
        }
        ...
        void ShowItemPrefabDataList(LoopListView2 listView)
        {
            ...
            for (int i = 0; i < mItemPrefabDataList.arraySize; i++)
            {
                ...
                SerializedProperty mItemPrefabHeight = itemData.FindPropertyRelative("mItemHeight");
                SerializedProperty mItemStartPosOffset = itemData.FindPropertyRelative("mStartPosOffset");
                SerializedProperty mItemAnimatorPath = itemData.FindPropertyRelative("mAnimatorPath");
                SerializedProperty mCancleMouseAnimation = itemData.FindPropertyRelative("mAnimationCancle");
                ...
                mItemPrefabHeight.floatValue = EditorGUILayout.FloatField("ItemHeight", mItemPrefabHeight.floatValue);
                ...
                mCancleMouseAnimation.boolValue = EditorGUILayout.Toggle("CancleAnimation", mCancleMouseAnimation.boolValue);
                if(mCancleMouseAnimation.boolValue)
                    mItemAnimatorPath.stringValue = EditorGUILayout.TextField("AnimatorPath", mItemAnimatorPath.stringValue);
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(mItemInterruptAnim, mItemInterruptAnimation);
