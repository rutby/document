...
public class AES
{
    ...
    public void MixColumns(ref byte[,] state)
    {
        ...
        for (c = 0; c < 4; c++)
        {
            ...
            for (r = 0; r < 4; r++)
            {
                state[r, c] = (byte)(FFmul(0x02, t[r]) ^ FFmul(0x03, t[(r + 1) % 4]) ^ FFmul(0x01, t[(r + 2) % 4]) ^ FFmul(0x01, t[(r + 3) % 4]));
            }
        }
    }
    ...
    public void InvMixColumns(ref byte[,] state)
    {
        ...
        for (c = 0; c < 4; c++)
        {
            ...
            for (r = 0; r < 4; r++)
            {
                state[r, c] = (byte)(FFmul(0x0e, t[r]) ^ FFmul(0x0b, t[(r + 1) % 4]) ^ FFmul(0x0d, t[(r + 2) % 4]) ^ FFmul(0x09, t[(r + 3) % 4]));
            }
        }
    }
