...
/// <summary>
    ...
    public static partial class ReferencePool
    {
        ...
        private static ReferenceCollection GetReferenceCollection(Type t)
        {
            ...
            lock (s_ReferenceCollections)
            {
                if (!s_ReferenceCollections.TryGetValue(t, out referenceCollection))
                {
                    referenceCollection = new ReferenceCollection();
                    s_ReferenceCollections.Add(t, referenceCollection);
                }
            }
