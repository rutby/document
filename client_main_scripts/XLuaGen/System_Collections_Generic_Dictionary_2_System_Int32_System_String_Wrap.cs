...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_SystemInt32SystemString_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(System.Collections.Generic.Dictionary<int, string>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new System.Collections.Generic.Dictionary<int, string>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new System.Collections.Generic.Dictionary<int, string>(_capacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<int>>(L, 2))
				{
					...
					var gen_ret = new System.Collections.Generic.Dictionary<int, string>(_comparer);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<int>>(L, 3))
				{
					...
					var gen_ret = new System.Collections.Generic.Dictionary<int, string>(_capacity, _comparer);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<int, string> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<int, string>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					System.Collections.Generic.Dictionary<int, string> gen_to_be_invoked = (System.Collections.Generic.Dictionary<int, string>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<int, string>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
        ...
        static int _m_TrimExcess(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<int, string>.TrimExcess!");
