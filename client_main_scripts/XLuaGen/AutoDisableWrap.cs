...
namespace XLua.CSObjectWrap
{
    ...
    public class AutoDisableWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(AutoDisable);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AutoDisable constructor!");
        ...
        static int _g_get_time(RealStatePtr L)
        {
		    try {
                ...
                AutoDisable gen_to_be_invoked = (AutoDisable)translator.FastGetCSObj(L, 1);
