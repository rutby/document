...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIScrollRectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 20, 27, 20);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ScrollRect_EndDrag", _m_ScrollRect_EndDrag);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetHorizontalNormalizedPosition", _m_SetHorizontalNormalizedPosition);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetHorizontalNormalizedPosition", _m_GetHorizontalNormalizedPosition);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ScrollRect_EndDrag(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ScrollRect_EndDrag(  );
        ...
        static int _m_SetHorizontalNormalizedPosition(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetHorizontalNormalizedPosition( _ratio );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetHorizontalNormalizedPosition(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetHorizontalNormalizedPosition(  );
