...
namespace XLua.CSObjectWrap
{
    ...
    public class SuperScrollViewLoopListViewItem2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(SuperScrollView.LoopListViewItem2);
			Utils.BeginObjectRegister(type, L, translator, 0, 1, 23, 16);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CancleMouseClickAnimation", _m_CancleMouseClickAnimation);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ItemAnimatorPath", _g_get_ItemAnimatorPath);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ItemCancleAnimation", _g_get_ItemCancleAnimation);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ParentListView", _g_get_ParentListView);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "ItemAnimatorPath", _s_set_ItemAnimatorPath);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "ItemCancleAnimation", _s_set_ItemCancleAnimation);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "ParentListView", _s_set_ParentListView);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new SuperScrollView.LoopListViewItem2();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SuperScrollView.LoopListViewItem2 constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CancleMouseClickAnimation(RealStatePtr L)
        {
		    try {
                ...
                SuperScrollView.LoopListViewItem2 gen_to_be_invoked = (SuperScrollView.LoopListViewItem2)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    
                    gen_to_be_invoked.CancleMouseClickAnimation(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ItemAnimatorPath(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                SuperScrollView.LoopListViewItem2 gen_to_be_invoked = (SuperScrollView.LoopListViewItem2)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.ItemAnimatorPath);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ItemCancleAnimation(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                SuperScrollView.LoopListViewItem2 gen_to_be_invoked = (SuperScrollView.LoopListViewItem2)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.ItemCancleAnimation);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ParentListView(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                SuperScrollView.LoopListViewItem2 gen_to_be_invoked = (SuperScrollView.LoopListViewItem2)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.ParentListView);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ItemAnimatorPath(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                SuperScrollView.LoopListViewItem2 gen_to_be_invoked = (SuperScrollView.LoopListViewItem2)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.ItemAnimatorPath = LuaAPI.lua_tostring(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ItemCancleAnimation(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                SuperScrollView.LoopListViewItem2 gen_to_be_invoked = (SuperScrollView.LoopListViewItem2)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.ItemCancleAnimation = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ParentListView(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                SuperScrollView.LoopListViewItem2 gen_to_be_invoked = (SuperScrollView.LoopListViewItem2)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.ParentListView = (SuperScrollView.LoopListView2)translator.GetObject(L, 2, typeof(SuperScrollView.LoopListView2));
