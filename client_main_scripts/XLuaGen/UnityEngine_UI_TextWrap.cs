...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUITextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 13, 24, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetTimeStamp", _m_SetTimeStamp);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetTimeStamp(RealStatePtr L)
        {
		    try {
                ...
                {
                    long _leftMilliSecond = LuaAPI.lua_toint64(L, 2);
                    
                    gen_to_be_invoked.SetTimeStamp( _leftMilliSecond );
        ...
        static int _m_Native_SetText(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.UI.Text.Native_SetText!");
