...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_ResourceTypeSystemInt32_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(System.Collections.Generic.Dictionary<ResourceType, int>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new System.Collections.Generic.Dictionary<ResourceType, int>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new System.Collections.Generic.Dictionary<ResourceType, int>(_capacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<ResourceType>>(L, 2))
				{
					...
					var gen_ret = new System.Collections.Generic.Dictionary<ResourceType, int>(_comparer);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<ResourceType>>(L, 3))
				{
					...
					var gen_ret = new System.Collections.Generic.Dictionary<ResourceType, int>(_capacity, _comparer);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<ResourceType, int> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<ResourceType, int>>(L, 1) && translator.Assignable<ResourceType>(L, 2))
				{
					
					System.Collections.Generic.Dictionary<ResourceType, int> gen_to_be_invoked = (System.Collections.Generic.Dictionary<ResourceType, int>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<ResourceType, int>>(L, 1) && translator.Assignable<ResourceType>(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
        ...
        static int _m_TrimExcess(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<ResourceType, int>.TrimExcess!");
