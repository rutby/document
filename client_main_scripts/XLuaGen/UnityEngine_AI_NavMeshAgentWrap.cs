...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAINavMeshAgentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 15, 35, 22);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetDestinationXYZ", _m_SetDestinationXYZ);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Get_velocity", _m_Get_velocity);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetDestinationXYZ(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetDestinationXYZ( _x, _y, _z );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Get_velocity(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Get_velocity( out _x, out _y, out _z );
