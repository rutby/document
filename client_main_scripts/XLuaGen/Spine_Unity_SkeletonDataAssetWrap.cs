        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Spine.Unity.SkeletonDataAsset();
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.TextAsset>(L, 1)&& translator.Assignable<Spine.Unity.AtlasAssetBase>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _scale = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = Spine.Unity.SkeletonDataAsset.CreateRuntimeInstance( _skeletonDataFile, _atlasAsset, _initialize, _scale );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.TextAsset>(L, 1)&& translator.Assignable<Spine.Unity.AtlasAssetBase>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _initialize = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = Spine.Unity.SkeletonDataAsset.CreateRuntimeInstance( _skeletonDataFile, _atlasAsset, _initialize );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.TextAsset>(L, 1)&& translator.Assignable<Spine.Unity.AtlasAssetBase[]>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _scale = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        var gen_ret = Spine.Unity.SkeletonDataAsset.CreateRuntimeInstance( _skeletonDataFile, _atlasAssets, _initialize, _scale );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.TextAsset>(L, 1)&& translator.Assignable<Spine.Unity.AtlasAssetBase[]>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _initialize = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = Spine.Unity.SkeletonDataAsset.CreateRuntimeInstance( _skeletonDataFile, _atlasAssets, _initialize );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetAnimationStateData(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetAnimationStateData(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    bool _quiet = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetSkeletonData( _quiet );
                        translator.Push(L, gen_ret);
