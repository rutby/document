    ...
    public class DGTweeningDOTweenAnimationWrap 
    {
		    ...
		    try {
                ...
                
                {
                    System.Type _t = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        translator.PushDGTweeningDOTweenAnimationTargetType(L, gen_ret);
        ...
        static int _g_get_animationType(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                translator.PushDGTweeningDOTweenAnimationAnimationType(L, gen_to_be_invoked.animationType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_targetType(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                translator.PushDGTweeningDOTweenAnimationTargetType(L, gen_to_be_invoked.targetType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_forcedTargetType(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenAnimation gen_to_be_invoked = (DG.Tweening.DOTweenAnimation)translator.FastGetCSObj(L, 1);
                translator.PushDGTweeningDOTweenAnimationTargetType(L, gen_to_be_invoked.forcedTargetType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
