...
namespace XLua.CSObjectWrap
{
    ...
    public class ExplorePointInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(ExplorePointInfo);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ExplorePointInfo();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Protobuf.WorldPointInfo>(L, 2))
				{
					...
					var gen_ret = new ExplorePointInfo(_pi);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ExplorePointInfo constructor!");
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                ExplorePointInfo gen_to_be_invoked = (ExplorePointInfo)translator.FastGetCSObj(L, 1);
