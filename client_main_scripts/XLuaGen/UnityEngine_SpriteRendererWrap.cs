...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSpriteRendererWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set_color", _m_Set_color);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set_color_r", _m_Set_color_r);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set_color_g", _m_Set_color_g);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set_color_b", _m_Set_color_b);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set_color_a", _m_Set_color_a);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Get_color", _m_Get_color);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Get_color_r", _m_Get_color_r);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Get_color_g", _m_Get_color_g);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Get_color_b", _m_Get_color_b);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Get_color_a", _m_Get_color_a);
        ...
        static int _m_LoadSprite(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.SpriteRenderer.LoadSprite!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Set_color(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set_color( _r, _g, _b, _a );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Set_color_r(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set_color_r( _r );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Set_color_g(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set_color_g( _g );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Set_color_b(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set_color_b( _b );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Get_color(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Get_color( out _r, out _g, out _b, out _a );
                    LuaAPI.lua_pushnumber(L, _r);
                        
                    LuaAPI.lua_pushnumber(L, _g);
                        
                    LuaAPI.lua_pushnumber(L, _b);
                        
                    LuaAPI.lua_pushnumber(L, _a);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Get_color_r(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Get_color_r( out _r );
                    LuaAPI.lua_pushnumber(L, _r);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Get_color_g(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Get_color_g( out _g );
                    LuaAPI.lua_pushnumber(L, _g);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Get_color_b(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Get_color_b( out _b );
                    LuaAPI.lua_pushnumber(L, _b);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Get_color_a(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Get_color_a( out _a );
                    LuaAPI.lua_pushnumber(L, _a);
