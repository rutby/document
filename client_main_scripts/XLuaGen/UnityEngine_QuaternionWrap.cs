...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineQuaternionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 2, 9, 6, 5);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToEulerAngles", _m_ToEulerAngles);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToEulerAngles(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ToEulerAngles( out _x, out _y, out _z );
