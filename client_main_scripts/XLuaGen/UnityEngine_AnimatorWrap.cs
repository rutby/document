...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimatorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 57, 44, 20);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetTriggerId", _m_SetTriggerId);
        ...
        static int _m_PlayId(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    int _layerIdx = LuaAPI.xlua_tointeger(L, 3);
                    float _normalizedTime = (float)LuaAPI.lua_tonumber(L, 4);
                    
                    gen_to_be_invoked.PlayId( _stateNameToId, _layerIdx, _normalizedTime );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetTriggerId(RealStatePtr L)
        {
		    try {
                ...
                {
                    int _triggerNameToId = LuaAPI.xlua_tointeger(L, 2);
                    
                    gen_to_be_invoked.SetTriggerId( _triggerNameToId );
