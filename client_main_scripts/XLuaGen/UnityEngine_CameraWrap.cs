...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 56, 58, 44);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "WorldToScreenPoint_opti", _m_WorldToScreenPoint_opti);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "WorldToViewportPoint_opti", _m_WorldToViewportPoint_opti);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ViewportToWorldPoint_opti", _m_ViewportToWorldPoint_opti);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ScreenToWorldPoint_opti", _m_ScreenToWorldPoint_opti);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WorldToScreenPoint_opti(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.WorldToScreenPoint_opti( _x, _y, _z, out _ox, out _oy, out _oz );
                    LuaAPI.lua_pushnumber(L, _ox);
                        
                    LuaAPI.lua_pushnumber(L, _oy);
                        
                    LuaAPI.lua_pushnumber(L, _oz);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_WorldToViewportPoint_opti(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.WorldToViewportPoint_opti( _x, _y, _z, out _ox, out _oy, out _oz );
                    LuaAPI.lua_pushnumber(L, _ox);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ViewportToWorldPoint_opti(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ViewportToWorldPoint_opti( _x, _y, _z, out _ox, out _oy, out _oz );
                    LuaAPI.lua_pushnumber(L, _ox);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ScreenToWorldPoint_opti(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ScreenToWorldPoint_opti( _x, _y, _z, out _ox, out _oy, out _oz );
                    LuaAPI.lua_pushnumber(L, _ox);
