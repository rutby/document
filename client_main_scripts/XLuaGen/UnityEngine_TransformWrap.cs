...
using DG.Tweening;using GameKit.Base;
...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 103, 19, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetOrAddTransform", _m_GetOrAddTransform);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "FindId", _m_FindId);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "FindAndGetComponent", _m_FindAndGetComponent);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set_positionX", _m_Set_positionX);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set_positionY", _m_Set_positionY);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set_positionZ", _m_Set_positionZ);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Get_lossyScale", _m_Get_lossyScale);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetOrAddTransform(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _childName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetOrAddTransform( _childName );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& translator.Assignable<UnityEngine.Vector3>(L, 4)) 
                {
                    ...
                    UnityEngine.Vector3 _roll;translator.Get(L, 4, out _roll);
                    
                        var gen_ret = gen_to_be_invoked.GetOrAddTransform( _childName, _position, _roll );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& translator.Assignable<UnityEngine.Quaternion>(L, 4)) 
                {
                    ...
                    UnityEngine.Quaternion _rotation;translator.Get(L, 4, out _rotation);
                        ...
                        var gen_ret = gen_to_be_invoked.GetOrAddTransform( _childName, _position, _rotation );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.GetOrAddTransform!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_FindId(RealStatePtr L)
        {
		    try {
                ...
                {
                    int _pathToId = LuaAPI.xlua_tointeger(L, 2);
                    
                        var gen_ret = gen_to_be_invoked.FindId( _pathToId );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_FindAndGetComponent(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.Type _type = (System.Type)translator.GetObject(L, 3, typeof(System.Type));
                        ...
                        var gen_ret = gen_to_be_invoked.FindAndGetComponent( _path, _type );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Set_positionX(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set_positionX( _x );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Set_positionY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set_positionY( _x, _y, _z );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Set_positionZ(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Set_positionZ( _x, _y, _z );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Get_lossyScale(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Get_lossyScale( out _x, out _y, out _z );
                    LuaAPI.lua_pushnumber(L, _x);
