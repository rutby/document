...
namespace XLua.CSObjectWrap
{
    ...
    public class GetHDRIntensityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(GetHDRIntensity);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new GetHDRIntensity();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GetHDRIntensity constructor!");
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                GetHDRIntensity gen_to_be_invoked = (GetHDRIntensity)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.Init( _material );
