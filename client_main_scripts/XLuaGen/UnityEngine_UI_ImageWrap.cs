...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIImageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 14, 23, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "LoadHeadEx", _m_LoadHeadEx);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LoadHeadEx(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.LoadHeadEx( _uid, _pic, _picVer );
        ...
        static int _m_LoadSprite(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.UI.Image.LoadSprite!");
