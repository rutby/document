...
public class SteamManager : MonoBehaviour
{
	...
	protected virtual void Awake() {
		...
		try {
			...
			if (SteamAPI.RestartAppIfNecessary((AppId_t)2366120)) {
	...
	{
		Log.Info("[" + MicroTxnAuthorizationResponse_t.k_iCallback + " - MicroTxnAuthorizationResponse] - " +
    ...
    public void SetCallBack(Action<uint, ulong> callBack)
    {
#if !DISABLESTEAMWORKS
