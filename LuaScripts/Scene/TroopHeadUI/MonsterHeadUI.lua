...
local function ShowMarchInfo(self,marchInfo,isCreate)
    if isCreate== true then
        if marchInfo:GetMarchType() == NewMarchType.MONSTER or marchInfo:GetMarchType() == NewMarchType.BOSS 
                or marchInfo:GetMarchType() == NewMarchType.CHALLENGE_BOSS or marchInfo:GetMarchType() == NewMarchType.MONSTER_SIEGE then
...
MonsterHeadUI.SetCarAnger =SetCarAnger
MonsterHeadUI.SetEdenPoint =SetEdenPoint
