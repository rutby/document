...
--- DateTime: 2023/8/4 15:41
---
local EdenAllianceCityTip = BaseClass("EdenAllianceCityTip")
...
local posOffset = Vector3.New(-6, 0, -10)
...
local function SetAllianceColor(self,cityId)
    local pic = "Assets/Main/Sprites/LodIcon/"..self.data.icon.."_white"
    ...
    if cityData~=nil then
        if cityData.allianceId~=nil and cityData.allianceId~="" then
            if cityData.allianceId == LuaEntry.Player.allianceId then
                pic = "Assets/Main/Sprites/LodIcon/"..self.data.icon.."_blue"
                color = WorldBlueColor32
            elseif DataCenter.GloryManager:IsSameCampByAllianceId(cityData.allianceId) ==true then
                pic = "Assets/Main/Sprites/LodIcon/"..self.data.icon.."_yellow"
                color = WorldYellowColor32
            else
                pic = "Assets/Main/Sprites/LodIcon/"..self.data.icon.."_red"
...
EdenAllianceCityTip.OnCreate = OnCreate
EdenAllianceCityTip.OnDestroy = OnDestroy
EdenAllianceCityTip.OnClick = OnClick
EdenAllianceCityTip.SetData = SetData
EdenAllianceCityTip.SetName = SetName
EdenAllianceCityTip.SetLevel = SetLevel
EdenAllianceCityTip.SetTilePos = SetTilePos
EdenAllianceCityTip.SetPos = SetPos
EdenAllianceCityTip.SetNameBg = SetNameBg
EdenAllianceCityTip.SetAllianceColor = SetAllianceColor
EdenAllianceCityTip.CheckCityDeclare = CheckCityDeclare
EdenAllianceCityTip.OnClickDeclare = OnClickDeclare
EdenAllianceCityTip.SetLod =SetLod
return EdenAllianceCityTip