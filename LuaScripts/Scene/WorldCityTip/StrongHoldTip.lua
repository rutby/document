...
--- DateTime: 2023/7/19 21:56
---
local StrongHoldTip = BaseClass("StrongHoldTip")
...
local function SetAllianceColor(self,cityId)
    local pic = "Assets/Main/Sprites/LodIcon/UIStrongHold_white.png"
    local color = WorldWhiteColor32
    local cityData = DataCenter.WorldAllianceCityDataManager:GetStrongHoldDataByCityId(cityId)
    if cityData~=nil then
        if cityData.allianceId~=nil and cityData.allianceId~="" then
            if cityData.allianceId==LuaEntry.Player.allianceId then
                pic = "Assets/Main/Sprites/LodIcon/UIStrongHold_blue.png"
                color = WorldBlueColor32
            elseif DataCenter.GloryManager:IsSameCampByAllianceId(cityData.allianceId) ==true then
                pic = "Assets/Main/Sprites/LodIcon/UIStrongHold_blue.png"
                color = WorldBlueColor32
            else
                pic = "Assets/Main/Sprites/LodIcon/UIStrongHold_red.png"
...
local function SetName(self,cityId)
    ...
    local cityInfo = DataCenter.WorldAllianceCityDataManager:GetStrongHoldDataByCityId(cityId)
    ...
    --self.declareWar.transform:Set_localPosition(-pos_x, 0.037, 0)
    ---- 碰撞体宽度
...
StrongHoldTip.OnCreate = OnCreate
StrongHoldTip.OnDestroy = OnDestroy
StrongHoldTip.OnClick = OnClick
StrongHoldTip.SetData = SetData
StrongHoldTip.SetName = SetName
StrongHoldTip.SetLevel = SetLevel
StrongHoldTip.SetTilePos = SetTilePos
StrongHoldTip.SetPos = SetPos
StrongHoldTip.SetNameBg = SetNameBg
StrongHoldTip.SetAllianceColor = SetAllianceColor
StrongHoldTip.CheckCityDeclare = CheckCityDeclare
StrongHoldTip.OnClickDeclare = OnClickDeclare
StrongHoldTip.SetLod =SetLod
return StrongHoldTip