...
--- Created by Beef.
--- DateTime: 2023/1/30 18:48
---

local IChatItem = require "UI.UIChatNew.Component.ChatItem.IChatItem"
local ChatItemMailScoutResultContentShare = BaseClass("ChatItemMailScoutResultContentShare", IChatItem)
...
function ChatItemMailScoutResultContentShare:ComponentDefine()
...
function ChatItemMailScoutResultContentShare:OnClickBg()
...
function ChatItemMailScoutResultContentShare:OnCreate()
    base.OnCreate(self)
    self:ComponentDefine()
end

function ChatItemMailScoutResultContentShare:UpdateItem( chatdata, index )
    ...
    message.type = attachInfo.mailType or MailType.MAIL_SCOUT_RESULT
    message.title = "{\"h\":{}}"
    message.uid = 0
    message.createTime = tonumber(strContent.createTime)
...
-- override
function ChatItemMailScoutResultContentShare:GetTopOffset()
    if self._chatNameLayout then
...
-- override
function ChatItemMailScoutResultContentShare:UpdateTopOffset()
    local initOffset = 40
