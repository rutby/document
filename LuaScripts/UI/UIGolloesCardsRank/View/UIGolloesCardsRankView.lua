...
--- DateTime:
--- 
local UIGolloesCardsRankView = BaseClass("UIGolloesCardsRankView", UIBaseView)
...
function UIGolloesCardsRankView:OnCreate()
    base.OnCreate(self)
...
function UIGolloesCardsRankView:OnDestroy()
    base.OnDestroy(self)
end

function UIGolloesCardsRankView:OnEnable()
    base.OnEnable(self)
...
function UIGolloesCardsRankView:OnDisable()
    base.OnDisable(self)
end

function UIGolloesCardsRankView:OnAddListener()
    base.OnAddListener(self)
    self:AddUIListener(EventId.ActGolloesCardRank, self.OnRefresh)
end

function UIGolloesCardsRankView:OnRemoveListener()
    base.OnRemoveListener(self)
    self:RemoveUIListener(EventId.ActGolloesCardRank, self.OnRefresh)
end

function UIGolloesCardsRankView:RefreshRank(activityId)
    self.activityId = activityId
    SFSNetwork.SendMessage(MsgDefines.GetGolloesCardRank,activityId)
end

function UIGolloesCardsRankView:OnRefresh()
...
function UIGolloesCardsRankView:OnRankItemMoveOut( itemObj, index)
    self.scroll_view:RemoveComponent(itemObj.name, UIGolloesCardsRankCell)
end

function UIGolloesCardsRankView:ClearScroll()
