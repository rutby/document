...
--- Created by Beef.
--- DateTime: 2023/8/3 15:42
---

local UIEdenKillRankItem = BaseClass("UIEdenKillRankItem", UIBaseContainer)
...
UIEdenKillRankItem.OnCreate = OnCreate
UIEdenKillRankItem.OnDestroy = OnDestroy
UIEdenKillRankItem.ComponentDefine = ComponentDefine
UIEdenKillRankItem.ComponentDestroy = ComponentDestroy
UIEdenKillRankItem.DataDefine = DataDefine
UIEdenKillRankItem.DataDestroy = DataDestroy
UIEdenKillRankItem.OnAddListener = OnAddListener
UIEdenKillRankItem.OnRemoveListener = OnRemoveListener
UIEdenKillRankItem.OnEnable = OnEnable
UIEdenKillRankItem.OnDisable = OnDisable

UIEdenKillRankItem.SetData = SetData
UIEdenKillRankItem.SetOnClick = SetOnClick
UIEdenKillRankItem.OnClick = OnClick
UIEdenKillRankItem.OnHeadClick = OnHeadClick

return UIEdenKillRankItem