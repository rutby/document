...
--- Created by Beef.
--- DateTime: 2023/8/3 12:15
---

local UIChaseDeerRewardItem = BaseClass("UIChaseDeerRewardItem", UIBaseContainer)
...
UIChaseDeerRewardItem.OnCreate = OnCreate
UIChaseDeerRewardItem.OnDestroy = OnDestroy
UIChaseDeerRewardItem.OnEnable = OnEnable
UIChaseDeerRewardItem.OnDisable = OnDisable
UIChaseDeerRewardItem.ComponentDefine = ComponentDefine
UIChaseDeerRewardItem.ComponentDestroy = ComponentDestroy
UIChaseDeerRewardItem.DataDefine = DataDefine
UIChaseDeerRewardItem.DataDestroy = DataDestroy
UIChaseDeerRewardItem.OnAddListener = OnAddListener
UIChaseDeerRewardItem.OnRemoveListener = OnRemoveListener

UIChaseDeerRewardItem.SetData = SetData

return UIChaseDeerRewardItem