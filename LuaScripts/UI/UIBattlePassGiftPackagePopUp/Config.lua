...
local UIBattlePassGiftPackagePopUp = {
	...
	PrefabPath = "Assets/Main/Prefab_Dir/UI/ActivityCenter/BattlePass/UIBattlePassGiftPackagePopUp.prefab",
}

return {
	-- 配置
	UIBattlePassGiftPackagePopUp = UIBattlePassGiftPackagePopUp,
}
