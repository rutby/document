...
---
local UICrossWonderRankItem = BaseClass("UICrossWonderRankItem", UIBaseContainer)
...
UICrossWonderRankItem.OnCreate = OnCreate
UICrossWonderRankItem.OnDestroy = OnDestroy
UICrossWonderRankItem.ComponentDefine = ComponentDefine
UICrossWonderRankItem.ComponentDestroy = ComponentDestroy
UICrossWonderRankItem.DataDefine = DataDefine
UICrossWonderRankItem.DataDestroy = DataDestroy
UICrossWonderRankItem.OnAddListener = OnAddListener
UICrossWonderRankItem.OnRemoveListener = OnRemoveListener
UICrossWonderRankItem.OnEnable = OnEnable
UICrossWonderRankItem.OnDisable = OnDisable

UICrossWonderRankItem.SetData = SetData
UICrossWonderRankItem.SetOnClick = SetOnClick
UICrossWonderRankItem.OnClick = OnClick
UICrossWonderRankItem.OnHeadClick = OnHeadClick

return UICrossWonderRankItem