...
local function ResetPositions(self)
    DataCenter.ZombieBattleManager:ResetHeroPos()
end
...
local function MoveHeroSlotPos(self, index, screenPos)
    ...
    DataCenter.ZombieBattleManager:SetHeroPos(index, pos)
end

--- 移动固定槽位到其他槽位为止
local function HeroSlotMoveToIndex(self,index,dstIndex,time)
    DataCenter.ZombieBattleManager:HeroMoveToIndex(index,dstIndex,time)
end
