...
local function OnDesClick(self)
    ...
    elseif self.isLeft == true then
        position = self.des_btn.gameObject.transform.position + Vector3.New(171, -48, 0) * scaleFactor
    end
    local endTime =0
...
local function SetTipLeft(self)
    self.isLeft = true
end
...
FormationStaminaSlider.SetTipLeft = SetTipLeft
