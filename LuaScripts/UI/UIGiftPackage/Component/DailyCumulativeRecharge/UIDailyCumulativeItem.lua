...
local UIDailyCumulativeItem = BaseClass("UIDailyCumulativeItem", UIBaseContainer)
...
local function RefreshProcess(self)
	local path = "Assets/Main/Sprites/UI/UICumulativrecharge/"
	if self.param.isFirst then
		self.processBg:LoadSprite(path .. "torch_bar_a01.png")
		self.imgUp:LoadSprite(path .. "torch_bar_a02.png")
		self.imgDown:LoadSprite(path .. "torch_bar_b02.png")
	elseif self.param.isLast1 then
		self.processBg:LoadSprite(path .. "torch_bar_d01.png")
		self.imgUp:LoadSprite(path .. "torch_bar_b02.png")
		self.imgDown:LoadSprite(path .. "torch_bar_d02.png")
	elseif self.param.isLast2 then
		self.processBg:LoadSprite(path .. "torch_bar_c01.png")
		self.imgUp:LoadSprite(path .. "torch_bar_b02.png")
		self.imgDown:LoadSprite(path .. "torch_bar_b02.png")
	else
		self.processBg:LoadSprite(path .. "torch_bar_b01.png")
		self.imgUp:LoadSprite(path .. "torch_bar_b02.png")
		self.imgDown:LoadSprite(path .. "torch_bar_b02.png")
	end
...
UIDailyCumulativeItem.OnCreate = OnCreate
UIDailyCumulativeItem.OnDestroy = OnDestroy
UIDailyCumulativeItem.ReInit = ReInit
UIDailyCumulativeItem.ComponentDefine = ComponentDefine
UIDailyCumulativeItem.ComponentDestroy = ComponentDestroy
UIDailyCumulativeItem.DataDefine = DataDefine
UIDailyCumulativeItem.DataDestroy = DataDestroy
UIDailyCumulativeItem.OnClickReward = OnClickReward
UIDailyCumulativeItem.ClearScroll = ClearScroll
UIDailyCumulativeItem.OnCreateCell = OnCreateCell
UIDailyCumulativeItem.OnDeleteCell = OnDeleteCell
UIDailyCumulativeItem.RewardUpdate = RewardUpdate
UIDailyCumulativeItem.OnDrag = OnDrag
UIDailyCumulativeItem.OnEndDrag = OnEndDrag
UIDailyCumulativeItem.OnBeginDrag = OnBeginDrag
UIDailyCumulativeItem.RefreshProcess = RefreshProcess

return UIDailyCumulativeItem 