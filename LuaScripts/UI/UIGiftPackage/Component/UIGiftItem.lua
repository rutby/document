local UIItem = BaseClass("UIItem", UIBaseContainer)
...
UIItem.OnCreate = OnCreate
UIItem.OnDestroy = OnDestroy
UIItem.Param = Param
UIItem.OnBtnClick = OnBtnClick
UIItem.OnEnable = OnEnable
UIItem.OnDisable = OnDisable
UIItem.ComponentDefine = ComponentDefine
UIItem.ComponentDestroy = ComponentDestroy
UIItem.DataDefine = DataDefine
UIItem.DataDestroy = DataDestroy
UIItem.ReInit = ReInit
UIItem.SetItemIconImage = SetItemIconImage
UIItem.SetItemQualityImage = SetItemQualityImage
UIItem.SetFlagActive = SetFlagActive
UIItem.SetFlagText = SetFlagText
UIItem.SetCountText = SetCountText
