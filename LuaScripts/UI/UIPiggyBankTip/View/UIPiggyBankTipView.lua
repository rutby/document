...
local UIPiggyBankTip = BaseClass("UIPiggyBankTip", UIBaseView)
...
local function DropCoin(self)
    local request = ResourceManager:InstantiateAsync(UIAssets.UIPiggyBankDropCoin)
...
local function OnClick(self)
    ...
    self.ctrl:CloseSelf()
    UIManager:GetInstance():OpenWindow(UIWindowNames.UIGiftPackage, { anim = true }, { welfareTagType = WelfareTagType.PiggyBank })
end

UIPiggyBankTip.OnCreate = OnCreate
UIPiggyBankTip.OnDestroy = OnDestroy
UIPiggyBankTip.OnEnable = OnEnable
UIPiggyBankTip.OnDisable = OnDisable
UIPiggyBankTip.ComponentDefine = ComponentDefine
UIPiggyBankTip.ComponentDestroy = ComponentDestroy
UIPiggyBankTip.DataDefine = DataDefine
UIPiggyBankTip.DataDestroy = DataDestroy
UIPiggyBankTip.OnAddListener = OnAddListener
UIPiggyBankTip.OnRemoveListener = OnRemoveListener

UIPiggyBankTip.ReInit = ReInit
UIPiggyBankTip.Refresh = Refresh
UIPiggyBankTip.SetPro = SetPro
UIPiggyBankTip.CheckReady = CheckReady
UIPiggyBankTip.IsReady = IsReady
UIPiggyBankTip.StartDropCoin = StartDropCoin
UIPiggyBankTip.StopDropCoin = StopDropCoin
UIPiggyBankTip.DropCoin = DropCoin
UIPiggyBankTip.OnClick = OnClick

return UIPiggyBankTip