local UIALVSDonateSoldierOpenReward = BaseClass("UIALVSDonateSoldierOpenRewardCtrl", UIBaseCtrl)

local function CloseSelf(self)
	UIManager.Instance:DestroyWindow(UIWindowNames.UIALVSDonateSoldierOpenReward)
end
...
UIALVSDonateSoldierOpenReward.CloseSelf = CloseSelf
UIALVSDonateSoldierOpenReward.Close = Close
UIALVSDonateSoldierOpenReward.CreateGoodsMap = CreateGoodsMap


return UIALVSDonateSoldierOpenReward