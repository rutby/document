...
local UIALVSDonateRankItem = BaseClass("UIALVSDonateRankItem", UIBaseContainer)
...
UIALVSDonateRankItem.OnCreate= OnCreate
UIALVSDonateRankItem.OnDestroy = OnDestroy
UIALVSDonateRankItem.ComponentDefine = ComponentDefine
UIALVSDonateRankItem.ComponentDestroy = ComponentDestroy
UIALVSDonateRankItem.DataDefine = DataDefine
UIALVSDonateRankItem.DataDestroy = DataDestroy
UIALVSDonateRankItem.OnEnable = OnEnable
UIALVSDonateRankItem.OnDisable = OnDisable
UIALVSDonateRankItem.OnAddListener = OnAddListener
UIALVSDonateRankItem.OnRemoveListener = OnRemoveListener
UIALVSDonateRankItem.SetData = SetData

return UIALVSDonateRankItem