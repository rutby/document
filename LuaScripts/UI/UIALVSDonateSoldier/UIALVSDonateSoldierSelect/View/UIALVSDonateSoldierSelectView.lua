local UIALVSDonateSoldierSelectView = BaseClass("UIALVSDonateSoldierSelectView", UIBaseView)
local base = UIBaseView
local ALVSDonateSoldierChooseCell = require "UI.UIALVSDonateSoldier.UIALVSDonateSoldierSelect.Component.ALVSDonateSoldierChooseCell"
...
local function OnAddListener(self)
    ...
    self:AddUIListener(EventId.ALVSDonateSoldier, BindCallback(self, self.CheckRewardRedPt))
...
local function OnRemoveListener(self)
    ...
    self:RemoveUIListener(EventId.ALVSDonateSoldier, BindCallback(self, self.CheckRewardRedPt))
...
local function OnClearScrollCells(self)
    ...
    self.soldier_scroll_view:RemoveComponents(ALVSDonateSoldierChooseCell)
end
...
local function OnDonateSoldierCellMoveIn(self, itemObj, index)
    ...
    local soldierCell = self.soldier_scroll_view:AddComponent(ALVSDonateSoldierChooseCell, itemObj)
...
local function OnDonateSoldierCellMoveOut(self, itemObj, index)
    self.soldier_scroll_view:RemoveComponent(itemObj.name, ALVSDonateSoldierChooseCell);
end

local function SetViewLabelText(self)
    --当前分数和等级
    local currLevel = self.ctrl.GetCurrLevelNum()
    local currPlayerScore = DataCenter.ActivityALVSDonateSoldierManager:GetScoreNumberByType(0)
...
UIALVSDonateSoldierSelectView.OnCreate = OnCreate
UIALVSDonateSoldierSelectView.OnDestroy = OnDestroy
UIALVSDonateSoldierSelectView.OnEnable = OnEnable
UIALVSDonateSoldierSelectView.OnDisable = OnDisable
UIALVSDonateSoldierSelectView.ComponentDefine = ComponentDefine
UIALVSDonateSoldierSelectView.ComponentDestroy = ComponentDestroy
UIALVSDonateSoldierSelectView.OnClearScrollCells = OnClearScrollCells
UIALVSDonateSoldierSelectView.OnDonateSoldierCellMoveIn = OnDonateSoldierCellMoveIn
UIALVSDonateSoldierSelectView.OnDonateSoldierCellMoveOut = OnDonateSoldierCellMoveOut
UIALVSDonateSoldierSelectView.ReloadScrollView = ReloadScrollView
UIALVSDonateSoldierSelectView.OnAddListener = OnAddListener
UIALVSDonateSoldierSelectView.OnRemoveListener = OnRemoveListener
UIALVSDonateSoldierSelectView.OnArmyNumChange = OnArmyNumChange
UIALVSDonateSoldierSelectView.SetViewLabelText = SetViewLabelText
UIALVSDonateSoldierSelectView.UpdateViewState = UpdateViewState
UIALVSDonateSoldierSelectView.RefreshAddNumLabel = RefreshAddNumLabel
UIALVSDonateSoldierSelectView.CheckRewardRedPt = CheckRewardRedPt
UIALVSDonateSoldierSelectView.ReachMaxCheckFunc = ReachMaxCheckFunc


return UIALVSDonateSoldierSelectView