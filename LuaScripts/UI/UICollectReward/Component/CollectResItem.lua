...
local CollectResItem = BaseClass("CollectResItem", UIBaseContainer)
...
local function ReInit(self,param)
    ...
    -- self.img_firstKill:SetActive(param.firstKill)
...
CollectResItem.OnCreate = OnCreate
CollectResItem.OnDestroy = OnDestroy
CollectResItem.Param = Param
CollectResItem.OnBtnClick = OnBtnClick
CollectResItem.OnEnable = OnEnable
CollectResItem.OnDisable = OnDisable
CollectResItem.ComponentDefine = ComponentDefine
CollectResItem.ComponentDestroy = ComponentDestroy
CollectResItem.DataDefine = DataDefine
CollectResItem.DataDestroy = DataDestroy
CollectResItem.ReInit = ReInit
CollectResItem.SetItemIconImage = SetItemIconImage
CollectResItem.SetItemQualityImage = SetItemQualityImage
CollectResItem.SetItemCountActive = SetItemCountActive
CollectResItem.SetItemCount = SetItemCount
CollectResItem.SetItemCountColor = SetItemCountColor
CollectResItem.SetFlagActive = SetFlagActive
CollectResItem.SetFlagText = SetFlagText
CollectResItem.SetNameText = SetNameText
CollectResItem.GetPosition = GetPosition
CollectResItem.GetResName = GetResName

return CollectResItem