...
local UIHeroEquipInfoAttrCell = BaseClass('UIHeroEquipInfoAttrCell', UIBaseContainer)
...
function UIHeroEquipInfoAttrCell:OnCreate()
    base.OnCreate(self)
    self:DataDefine()
    self:ComponentDefine()
end

function UIHeroEquipInfoAttrCell:OnDestroy()
    self:DataDestroy()
    self:ComponentDestroy()
    base.OnDestroy(self)
end

function UIHeroEquipInfoAttrCell:DataDefine()
    self.data = {}
end

function UIHeroEquipInfoAttrCell:DataDestroy()
    self.data = {}
end

function UIHeroEquipInfoAttrCell:ComponentDefine()
...
function UIHeroEquipInfoAttrCell:ComponentDestroy()

end

function UIHeroEquipInfoAttrCell:SetData(data)
    self.data = data
    ...
    if self.data.isBase then
        ...
        elseif self.data.isPromote then
            ...
            self.desc:SetLocalText(self.data.desc)
            self.value:SetText(self.data.value)
            self.desc:SetColor(GreenColor)
            self.value:SetColor(GreenColor)
...
return UIHeroEquipInfoAttrCell