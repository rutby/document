...
--- DateTime:
--- 
local UIDonateSoldierOpenRewardView = BaseClass("UIDonateSoldierOpenRewardView", UIBaseView)
...
local function OnClickOpen(self)
    ...
    if canOpen then
        DataCenter.ActivityDonateSoldierManager:OnReceiveStageReward(2, idList)
        self.ctrl:CloseSelf()
    else
...
UIDonateSoldierOpenRewardView.OnCreate = OnCreate
UIDonateSoldierOpenRewardView.OnDestroy = OnDestroy
UIDonateSoldierOpenRewardView.OnEnable = OnEnable
UIDonateSoldierOpenRewardView.OnDisable = OnDisable
UIDonateSoldierOpenRewardView.ComponentDefine = ComponentDefine
UIDonateSoldierOpenRewardView.ComponentDestroy = ComponentDestroy
UIDonateSoldierOpenRewardView.OnAddListener = OnAddListener
UIDonateSoldierOpenRewardView.OnRemoveListener = OnRemoveListener
UIDonateSoldierOpenRewardView.ReInit = ReInit
UIDonateSoldierOpenRewardView.OnRefresh = OnRefresh
UIDonateSoldierOpenRewardView.RefreshReward = RefreshReward
UIDonateSoldierOpenRewardView.OnClickOpen = OnClickOpen
UIDonateSoldierOpenRewardView.GetShowNeedCount = GetShowNeedCount

return UIDonateSoldierOpenRewardView