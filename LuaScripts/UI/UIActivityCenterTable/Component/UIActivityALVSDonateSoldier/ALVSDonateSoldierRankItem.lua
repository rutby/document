local ALVSDonateSoldierRankItem = BaseClass("ALVSDonateSoldierRankItem", UIBaseContainer)
...
ALVSDonateSoldierRankItem.OnCreate = OnCreate
ALVSDonateSoldierRankItem.OnDestroy = OnDestroy
ALVSDonateSoldierRankItem.OnEnable = OnEnable
ALVSDonateSoldierRankItem.OnDisable = OnDisable
ALVSDonateSoldierRankItem.ComponentDefine = ComponentDefine
ALVSDonateSoldierRankItem.ComponentDestroy = ComponentDestroy
ALVSDonateSoldierRankItem.SetData = SetData
ALVSDonateSoldierRankItem.OnPlayerCellClick = OnPlayerCellClick

return ALVSDonateSoldierRankItem