...
---
local LeadingQuestResItem = BaseClass("LeadingQuestResItem", UIBaseContainer)
...
LeadingQuestResItem.OnCreate = OnCreate
LeadingQuestResItem.OnDestroy = OnDestroy
LeadingQuestResItem.OnBtnClick = OnBtnClick
LeadingQuestResItem.OnEnable = OnEnable
LeadingQuestResItem.OnDisable = OnDisable
LeadingQuestResItem.RefreshData = RefreshData

return LeadingQuestResItem