...
local HeroEvolveGiftCell = BaseClass("HeroEvolveGiftCell", UIBaseContainer)
...
HeroEvolveGiftCell.OnCreate = OnCreate
HeroEvolveGiftCell.OnDestroy = OnDestroy
HeroEvolveGiftCell.Param = Param
HeroEvolveGiftCell.OnBtnClick = OnBtnClick
HeroEvolveGiftCell.OnEnable = OnEnable
HeroEvolveGiftCell.OnDisable = OnDisable
HeroEvolveGiftCell.ComponentDefine = ComponentDefine
HeroEvolveGiftCell.ComponentDestroy = ComponentDestroy
HeroEvolveGiftCell.DataDefine = DataDefine
HeroEvolveGiftCell.DataDestroy = DataDestroy
HeroEvolveGiftCell.ReInit = ReInit
HeroEvolveGiftCell.SetItemIconImage = SetItemIconImage
HeroEvolveGiftCell.SetItemQualityImage = SetItemQualityImage
HeroEvolveGiftCell.SetItemCountActive = SetItemCountActive
HeroEvolveGiftCell.SetItemCount = SetItemCount
HeroEvolveGiftCell.SetItemCountColor = SetItemCountColor
HeroEvolveGiftCell.SetFlagActive = SetFlagActive
HeroEvolveGiftCell.SetCheckActive = SetCheckActive
HeroEvolveGiftCell.SetFlagText = SetFlagText
HeroEvolveGiftCell.SetNameText = SetNameText
HeroEvolveGiftCell.GetPosition = GetPosition
HeroEvolveGiftCell.GetResName = GetResName
HeroEvolveGiftCell.GetIconPath = GetIconPath

return HeroEvolveGiftCell