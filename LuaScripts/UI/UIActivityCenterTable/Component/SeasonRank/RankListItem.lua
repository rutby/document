...
local function OnCreate(self)
   ...
   -- self.power_txt = self:AddComponent(UIText,power_path)
	...
	self._desertLv_txt = self:AddComponent(UIText,"Txt_DesertLv")
	
	self._desertTime_txt = self:AddComponent(UIText,"Txt_DesertTime")
...
local function SetItemShow(self, data)
	...
	if self.data.abbr == "" then
		...
		local allianceName = "["..self.data.abbr.."]"..self.data.alName
		self._allianceName_txt:SetText(allianceName)
	end
	...
	self._desertLv_txt:SetText(self.data.level)
	
	self._desertTime_txt:SetText(UITimeManager:GetInstance():TimeStampToTimeForServerMinute(self.data.time))
