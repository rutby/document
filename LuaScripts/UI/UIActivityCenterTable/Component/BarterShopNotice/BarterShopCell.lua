...
--- Created by Beef.
--- DateTime: 2022/1/20 10:59
---

local BarterShopCell = BaseClass("BarterShopCell", UIBaseContainer)
...
local function ReInit(self,param)
    ...
    if self.param.rewardType == nil then
        ...
        elseif self.param.rewardType == RewardType.OIL or self.param.rewardType == RewardType.METAL or self.param.rewardType == RewardType.FORMATION_STAMINA
                or self.param.rewardType == RewardType.WATER or self.param.rewardType == RewardType.PVE_POINT or self.param.rewardType == RewardType.DETECT_EVENT
...
BarterShopCell.OnCreate = OnCreate
BarterShopCell.OnDestroy = OnDestroy
BarterShopCell.Param = Param
BarterShopCell.OnBtnClick = OnBtnClick
BarterShopCell.OnEnable = OnEnable
BarterShopCell.OnDisable = OnDisable
BarterShopCell.ComponentDefine = ComponentDefine
BarterShopCell.ComponentDestroy = ComponentDestroy
BarterShopCell.DataDefine = DataDefine
BarterShopCell.DataDestroy = DataDestroy
BarterShopCell.ReInit = ReInit
BarterShopCell.SetItemIconImage = SetItemIconImage
BarterShopCell.SetItemQualityImage = SetItemQualityImage
BarterShopCell.SetItemCountActive = SetItemCountActive
BarterShopCell.SetItemCount = SetItemCount
BarterShopCell.SetFlagActive = SetFlagActive
BarterShopCell.SetFlagText = SetFlagText
BarterShopCell.SetNameText = SetNameText


return BarterShopCell