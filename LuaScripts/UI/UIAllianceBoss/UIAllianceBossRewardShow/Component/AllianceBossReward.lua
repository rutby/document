...
local AllianceBossReward = BaseClass("AllianceBossReward", UIBaseContainer)
...
local item_bg_path = "UICommonItemSize/clickBtn/item_bg"
local hero_quality_path = "UICommonItemSize/clickBtn/HeroQuality"
local item_quality_path = "UICommonItemSize/clickBtn/ImgQuality"
local item_icon_path = "UICommonItemSize/clickBtn/ItemIcon"
local num_text_path = "UICommonItemSize/clickBtn/NumText"
local flag_path = "UICommonItemSize/clickBtn/FlagGo"
local flag_text_path = "UICommonItemSize/clickBtn/FlagGo/FlagText"
local this_path = "UICommonItemSize/clickBtn"
local extra_path = "UICommonItemSize/clickBtn/ImgExtra"
local camp_path = "UICommonItemSize/clickBtn/ImgCamp"
local check_path = "UICommonItemSize/clickBtn/ImgRece"
local img_firstKill = "UICommonItemSize/clickBtn/Img_FirstKill"
local small_multiple_bg_path = "smallMultipleBg"
local attack_box_multiple_label_path = "AttackBoxMultipleLabel"
-- 创建
...
local function LoadBossInfo(self,smallIconPath,lv)
    if smallIconPath then
        self.small_multiple_bg:SetActive(true)
        self.small_multiple_bg:LoadSprite(smallIconPath)
    else
        self.small_multiple_bg:SetActive(false)
    end
    if lv then
        self.attack_box_multiple_label:SetActive(true)
        self.attack_box_multiple_label:SetText(lv)
    else
        self.attack_box_multiple_label:SetActive(false)
    end
end

AllianceBossReward.OnCreate = OnCreate
AllianceBossReward.OnDestroy = OnDestroy
AllianceBossReward.OnBtnClick = OnBtnClick
AllianceBossReward.OnEnable = OnEnable
AllianceBossReward.OnDisable = OnDisable
AllianceBossReward.ComponentDefine = ComponentDefine
AllianceBossReward.ComponentDestroy = ComponentDestroy
AllianceBossReward.DataDefine = DataDefine
AllianceBossReward.DataDestroy = DataDestroy
AllianceBossReward.ReInit = ReInit
AllianceBossReward.SetItemIconImage = SetItemIconImage
AllianceBossReward.SetItemQualityImage = SetItemQualityImage
AllianceBossReward.SetItemCountActive = SetItemCountActive
AllianceBossReward.SetItemCount = SetItemCount
AllianceBossReward.SetItemCountColor = SetItemCountColor
AllianceBossReward.SetFlagActive = SetFlagActive
AllianceBossReward.SetCheckActive = SetCheckActive
AllianceBossReward.SetFlagText = SetFlagText
AllianceBossReward.SetNameText = SetNameText
AllianceBossReward.GetPosition = GetPosition
AllianceBossReward.GetResName = GetResName
AllianceBossReward.LoadBossInfo = LoadBossInfo

return AllianceBossReward