...
local LMRewardItemCell = BaseClass("LMRewardItemCell", UIBaseContainer)
...
LMRewardItemCell.OnCreate = OnCreate
LMRewardItemCell.OnDestroy = OnDestroy
LMRewardItemCell.Param = Param
LMRewardItemCell.OnBtnClick = OnBtnClick
LMRewardItemCell.OnEnable = OnEnable
LMRewardItemCell.OnDisable = OnDisable
LMRewardItemCell.ComponentDefine = ComponentDefine
LMRewardItemCell.ComponentDestroy = ComponentDestroy
LMRewardItemCell.DataDefine = DataDefine
LMRewardItemCell.DataDestroy = DataDestroy
LMRewardItemCell.ReInit = ReInit
LMRewardItemCell.SetItemIconImage = SetItemIconImage
LMRewardItemCell.SetItemQualityImage = SetItemQualityImage
LMRewardItemCell.SetItemCountActive = SetItemCountActive
LMRewardItemCell.SetItemCount = SetItemCount
LMRewardItemCell.SetItemCountColor = SetItemCountColor
LMRewardItemCell.SetFlagActive = SetFlagActive
LMRewardItemCell.SetCheckActive = SetCheckActive
LMRewardItemCell.SetFlagText = SetFlagText
LMRewardItemCell.SetNameText = SetNameText
LMRewardItemCell.GetPosition = GetPosition
LMRewardItemCell.GetResName = GetResName
LMRewardItemCell.GetIconPath = GetIconPath

return LMRewardItemCell