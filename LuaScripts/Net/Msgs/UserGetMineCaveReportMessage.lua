...
--- Created by 1.
--- DateTime: 2022/7/28 12:13
---UserGetMineCaveReportMessage

local UserGetMineCaveReportMessage = BaseClass("UserGetMineCaveReportMessage", SFSBaseMessage)
...
local function HandleMessage(self, t)
    ...
    if t["errorCode"] ~= nil then
        ...
        message.type = MailType.NEW_FIGHT_MINECAVE
        message.title = "{\"h\":{}}"
        message.uid = 0
        ...
        --message.createTime = UITimeManager:GetInstance():GetServerTime()
        ...
        if mailInfo ~= nil then
            UIManager:GetInstance():OpenWindow(UIWindowNames.UIShareMail, NormalBlurPanelAnim,mailInfo,nil,PlayBackEndJumpType.MineCave, battleContent)
        end
    end

end

UserGetMineCaveReportMessage.OnCreate = OnCreate
UserGetMineCaveReportMessage.HandleMessage = HandleMessage

return UserGetMineCaveReportMessage