...
local GetALVSDonateArmyActivityInfoMessage = BaseClass("GetALVSDonateArmyActivityInfoMessage", SFSBaseMessage)
...
local function HandleMessage(self, t)
    ...
    if errCode ~= nil then
        ...
        --正常逻辑
        DataCenter.ActivityALVSDonateSoldierManager:OnHandleGetALVSDonateArmyActivityInfoMessage(t)
    end

end

GetALVSDonateArmyActivityInfoMessage.OnCreate = OnCreate
GetALVSDonateArmyActivityInfoMessage.HandleMessage = HandleMessage

return GetALVSDonateArmyActivityInfoMessage