...
--- Created by wsf.
--- DateTime: 2023/12/13 8:35 PM
--- 火箭弹
local Bullet = {}
Bullet.__index = Bullet

local RES_PATH = "Assets/_Art/Effect_B/Prefab/Arms/Tanke/Eff_tanke_zidan.prefab"
        ...
        if aimTarget and not aimTarget.dead then
            if aimTarget.shape:Overlap(self.box) then
                ...
                if aimTarget.onHit then
                    ...
                    if hit then
                        realHit = true
                        logic:PlayRocketEff(hitPos, self.dir)
                    end
                    --return hit
                end
            end
