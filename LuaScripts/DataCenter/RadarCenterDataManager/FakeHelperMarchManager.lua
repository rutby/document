...
---
---@class FakeHelperMarchManager
local FakeHelperMarchManager = BaseClass("FakeHelperMarchManager")
local FakeHelperMarchData = require "DataCenter.RadarCenterDataManager.FakeHelperMarchData"
...
local function AddMarchIndex(self, pointId)
    if self.allMarches[pointId] == nil then
        local data = FakeHelperMarchData.New()
...
FakeHelperMarchManager.__init = __init
FakeHelperMarchManager.__delete = __delete
FakeHelperMarchManager.AddMarchIndex = AddMarchIndex
FakeHelperMarchManager.RemoveMarchIndex = RemoveMarchIndex
FakeHelperMarchManager.AddTimer = AddTimer
FakeHelperMarchManager.RemoveTimer = RemoveTimer
FakeHelperMarchManager.CheckAndRefreshMarches = CheckAndRefreshMarches
FakeHelperMarchManager.RemoveAllDisappearEvent = RemoveAllDisappearEvent
FakeHelperMarchManager.StartMarch = StartMarch
FakeHelperMarchManager.IsEventDoing = IsEventDoing
FakeHelperMarchManager.NeedRemove = NeedRemove
FakeHelperMarchManager.DoWhenBackToWorld = DoWhenBackToWorld
FakeHelperMarchManager.AddListener = AddListener
FakeHelperMarchManager.RemoveListener = RemoveListener

return FakeHelperMarchManager