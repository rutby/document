...
--- DateTime: 
---
local AllianceMainManager = BaseClass("AllianceMainManager")
...
local function InitData(self)
	SFSNetwork.SendMessage(MsgDefines.ViewAllianceLog,0,false)
end
...
--是否是联盟log
function AllianceMainManager:IsAllianceLogType(logType)
	return not DataCenter.AllianceCityLogManager:IsAllianceCityLogType(logType)
end


AllianceMainManager.__init = __init
AllianceMainManager.__delete = __delete
AllianceMainManager.InitData = InitData
AllianceMainManager.UpdateAllianceLogData =UpdateAllianceLogData
AllianceMainManager.PushAllianceLogMemberHandle = PushAllianceLogMemberHandle
AllianceMainManager.GetAllLog = GetAllLog
AllianceMainManager.AnalyseLogTime =AnalyseLogTime
AllianceMainManager.GetAllianceLogById = GetAllianceLogById
AllianceMainManager.ClearAllianceLog = ClearAllianceLog
AllianceMainManager.GetLastLogTime = GetLastLogTime
AllianceMainManager.SetLastLogTime = SetLastLogTime
AllianceMainManager.GetAnalyseData = GetAnalyseData
return AllianceMainManager